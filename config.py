...
# Git
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/VIPBOLTE/STRANGER-krishMUSIC")
...
YOUR_API_KEY = getenv("YOUR_API_KEY", "StrangerApi1af4774")
YOUR_API_URL = getenv("YOUR_API_URL", "http://139.59.31.247:8080")
